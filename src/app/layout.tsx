...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    // --- 3D Web Development & Creative Freelancer Keywords ─────────────────
    "3d site freelance",
    "hire 3d web developer",
    "freelance threejs developer",
    "creative web developer portfolio",
    "react three fiber developer for hire",
    "3d product customizer developer",
    "interactive webgl website freelancer",
    "webgl developer india",
    "threejs website cost in india",
    "best 3d web designer",
    "immersive 3d landing page creator",
    "creative frontend engineer freelance",
    "3d graphics developer for hire",
    "hire creative technologist",
    "draco compression optimization expert",
    "3d portfolio website developer",
    "next.js 15 three.js integration",
    "react three fiber expert developer",
    "hire WebGL shader programmer",
    "interactive 3d web applications",
    "three.js animation specialist freelance",
    "custom 3d product configurator dev",
    "hire blender three.js web developer",
    "freelance creative developer usd",
    "3d web development services usa",
    "three.js consultant freelance",
    "webgl speed optimization freelance",
    "interactive canvas developer",
    "affordable 3d web development",
    "low cost threejs developer india",
    "creative coding website designer",
    "gltf web optimizer freelancer",
    "high performance 3d web development",
    "responsive threejs canvas setup",
    "react three fiber canvas developer",
    "webgl portfolio showcase",
    "hire threejs animator",
    "interactive 3d user interfaces",
    "custom webgl shader developer",
    "draco loader configurations react",
    "three.js mobile responsiveness specialist",
    "3d e-commerce web designer",
    "immersive coffee 3d cup customizer dev",
    "nextjs threejs build speed optimization",
    "vector mathematical 3d web expert",
    "webgl graphics performance expert",
    "hire remote creative web developer",
    "three.js developer for hire canada",
    "creative web builder london uk",
    "best 3d portfolio website design",
  ],
  alternates: {
    canonical: "/",
  },
