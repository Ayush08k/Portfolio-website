  ...
  const handleSendMessage = (textToSend: string) => {
    ...
    setTimeout(() => {
      ...
      if (lowerText.includes("availab") || lowerText.includes("free") || lowerText.includes("open") || lowerText.includes("schedule")) {
        ...
        reply = "Ayush specializes in elite engineering workflows:\n\n• Frontend: Next.js (React 19), TypeScript, Tailwind CSS, Framer Motion\n• Backend: Node.js, Express, Supabase, PostgreSQL, Firebase\n• Core Specialties: Fluid animations, sub-second page loads, and top-tier SEO layout optimization.";
